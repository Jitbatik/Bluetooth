...
//            val newValue = extractValueForLabel(label, byteDataList)
//            parametersMap[label] = parametersMap[label]
//                ?.let { updateExistingParameter(it, timeStamp, newValue) }
//                ?: addNewParameter(label, timeStamp, newValue)
//        }
//
//        return parametersMap.values.toList()
//    }
//
//    private fun addNewParameter(label: ParameterLabel, timeStamp: Int, value: Int): Parameter {
//        return Parameter(
//            id = label.hashCode(),
//            label = label,
//            points = listOf(ParameterPoint(timeStamp = timeStamp, value = value))
...
//        val newParameters =
//            existingTest.points + ParameterPoint(timeStamp = timeStamp, value = value)
//        return existingTest.copy(points = newParameters)
//    }
//
//
//    private fun extractValueForLabel(label: ParameterLabel, byteDataList: List<ByteData>): Int {
